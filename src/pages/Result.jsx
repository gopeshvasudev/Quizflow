...
import QuestionNumberCircle from "../components/QuestionNumberCircle";
import ResultPageSkeleton from "../components/ResultPageSkeleton";

const Result = () => {
  const { correctAnsweredQuestionsIndex, loading } =
  ...
  return (
    <section className="w-full h-screen p-4 flex justify-center">
      {loading ? (
        ...
        <div className="w-full sm:w-[600px] h-full rounded-lg p-4 bg-zinc-950 flex flex-col items-center justify-center gap-2">
          <h6 className="text-center text-5xl tracking-wide text-flow-400">
            No Result Found!
          </h6>
